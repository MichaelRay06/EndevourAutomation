...
var objectDataProvider2 = require('../dataResources/dataProvider2.js')
var using = require('jasmine-data-provider');
var confs=require('../configuration.js');
//var WhyCypressContent =require('../pages/WhyCypressContent.js');


describe('ENDEVOUR CYPRESS AUTOMATION : vrifying the page content of child window contains the text Why Cypress', function () {
    ...
    using(objectDataProvider2.dataDriven2, function (data, description) {
      it('verify that Cypress web site child window page content has the text WHY CYPRESS  : ' + description, async function () {
